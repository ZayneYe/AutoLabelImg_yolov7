...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def yolov7_auto_labeling(self):
        try:
            ...
            def change_result_type_yolov7(boxes, scores, labels):
                result = []
            ...
            if len(weight_list) > 0:
                weights, ok = QInputDialog.getItem(self, "Select",
                                                   "Model weights file(weights file should under 'yolov7/weights'):",
                                                   items, 0, False)
                if not ok:
                    return
                else:
                ...
                weights, _ = QFileDialog.getOpenFileName(self,
                                                         "'yolov7/weights' is empty, choose model weights file:")
            ...
            imgsz = check_img_size(imgsz, stride)  # check img_size
            ...
            progress.setLabelText(u"auto-labeling with yolov7 now,Please wait...")
            ...
            for path, img, im0s, vid_cap in dataset:
                ...
                for i, det in enumerate(pred):  # detections per image
                    ...
                    result = change_result_type_yolov7(boxes, scores, labels)
                    if len(result) > 0:
